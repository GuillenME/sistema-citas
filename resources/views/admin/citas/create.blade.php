    ...
    <div class="admin-citas-create">
        <div class="container">
            <div class="card booking-shell">
                ...
                <form method="POST" action="{{ route('admin.citas.store') }}" id="formAgendarCita"
        ...
        <div id="modalConfirmar" class="modal-confirm-overlay"
            ...
            <div class="modal-confirm-content">
                ...
                <div class="modal-confirm-buttons modal-confirm-buttons-spaced">
                    <button class="modal-confirm-btn modal-confirm-btn-submit" onclick="confirmarAgendar()">Confirmar y
                        agendar</button>
