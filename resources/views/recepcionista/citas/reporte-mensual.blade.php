    ...
    <div class="rm-shell">
        ...
        <section class="rm-card">
            <div class="rm-head">
                ...
                <form method="GET" action="{{ route('recepcionista.citas.reporte-mensual') }}" class="rm-form">
                    ...
                    <a href="{{ route('recepcionista.citas.reporte-mensual.pdf', ['mes' => $mesSeleccionado]) }}" class="rm-btn">Descargar PDF</a>
                </form>
            </div>
        </section>
