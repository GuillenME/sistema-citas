<nav class="navbar admin-sidebar" id="adminSidebar" aria-label="Menu de administracion">
    <div class="admin-sidebar-top">
        <a href="{{ route('admin.dashboard') }}" class="admin-brand">
            @if (!empty($homeSetting?->navbar_logo))
                <img src="{{ asset('storage/' . $homeSetting->navbar_logo) }}" alt="Barber & Spa" class="admin-brand-logo">
            @else
    ...
    <div class="navbar-right">
        <button class="btn-logout" wire:click="abrirLogout" aria-label="Cerrar sesion" title="Cerrar sesion">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
