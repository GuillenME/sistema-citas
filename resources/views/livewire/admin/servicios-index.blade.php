                    ...
                    @forelse ($servicios as $servicio)
                        <tr>
                            ...
                            <td class="serv-actions-col">
                                ...
                                <button class="serv-icon-btn delete" wire:click="confirmDelete({{ $servicio->id }})" title="Eliminar" aria-label="Eliminar">
    ...
    @if ($confirmDeleteId)
        <div class="modal-overlay" wire:click.self="cancelDelete">
            <div class="modal-box">
                ...
                <p>Esta accion desactivara el servicio.</p>
                <div class="modal-actions">
                    ...
                    <button class="btn btn-save" wire:click="deleteConfirmed" wire:loading.attr="disabled">
                        <span wire:loading.remove>Desactivar</span>
