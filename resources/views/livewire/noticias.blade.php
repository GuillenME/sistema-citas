<section id="noticias" class="home-section">
    <div class="news-header">
        ...
        <p class="news-subtitle">Lo ultimo en tendencias, promociones y novedades.</p>
    </div>
        ...
        @foreach ($noticias as $index => $noticia)
            <article class="news-card {{ $index % 2 === 0 ? 'down' : 'up' }}">
                ...
                <div class="news-body">
                    ...
                    <h3>{{ $noticia->title }}</h3>
                    <p>{{ \Illuminate\Support\Str::limit($noticia->content, 140) }}</p>
                </div>
    ...
    <div class="news-actions">
        <a href="{{ route('noticias.publicas') }}">Ver todas las noticias</a>
    </div>
</section>
